...
RUN="(progn (ql:quickload '(:meow/tests :meow/logger/tests :meow/hmr/tests) :silent t) (asdf:test-system :meow) (asdf:test-system :meow/logger) (asdf:test-system :meow/hmr))"
